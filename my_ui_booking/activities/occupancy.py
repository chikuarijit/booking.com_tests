...
class Occupancy:
    ...
    def children(self):
        children_container_element = self.driver.find_element(
            By.CLASS_NAME, "bfb38641b0"
        )  # Container element for children tab
        children_increase_button = children_container_element.find_element(
            By.CSS_SELECTOR, "button.children-increase-button"
        )  # Increase button within children tab
    ...
    def rooms(self):
        ...
        increase_button = parent_container_element.find_element(
